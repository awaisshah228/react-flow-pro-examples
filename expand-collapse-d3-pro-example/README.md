...
This example is built with the help of the [d3-hierarchy](https://github.com/d3/d3-hierarchy) package for the expand/collapse functionality and the tree layout.
